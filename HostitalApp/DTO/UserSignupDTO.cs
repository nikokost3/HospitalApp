...
namespace HospitalApp.DTO
{
    public class UserSignupDTO
    {
        ...
        [StringLength(100, ErrorMessage = "Clinic name should not exceed 100 characters.")]
        ...
        {
            return $"{Username} {Firstname} {Lastname} {Email} {Password} {PhoneNumber} {Clinic} {UserRole!.Value}";
        }
    }
}
