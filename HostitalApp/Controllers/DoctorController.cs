...
namespace HospitalApp.Controllers
{
    ...
    public class DoctorController : Controller
    {
        ...
        public UserDoctorReadOnlyDTO UserDoctor { get; set; }
        private readonly UsersDoctorsPatientDbContext _dbContext;

        private readonly IDoctorRepository _repository;

        public DoctorController(UsersDoctorsPatientDbContext dbContext)
        {
        ...
        public async Task<IActionResult> Profile(int? id)
        {
            ...
            var doctor = await _dbContext.Users.FirstOrDefaultAsync(m => m.Id == id);
            if (doctor == null)
            {
                return NotFound();
            }
